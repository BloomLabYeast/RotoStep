...
{
    double kBT = temperature_Kelvin * Boltzmann_constant;
    return sqrt( 12.0 * M_PI * effective_radius_meters * viscosity_Pascal_seconds
                 * (kBT / timestep_seconds) );
}
				...
				, double mass_kg)
{
    ...
    return drag_coefficient / mass_kg;
}
